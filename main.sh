...
REPO="https://raw.githubusercontent.com/SETANTAZVPN/abc/ipuk/"
CDNF="https://raw.githubusercontent.com/SETANTAZVPN/abc/ipuk"
...
function finish(){
    USRSC=$(curl -sS https://raw.githubusercontent.com/SETANTAZVPN/izinvps/ipuk/ip | grep $MYIP | awk '{print $2}')
    EXPSC=$(curl -sS https://raw.githubusercontent.com/SETANTAZVPN/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
